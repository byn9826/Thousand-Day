	...
	render() {
		return (
			<div id="react-root">
                ...
                <Profile visitorName={this.props.visitorName} user={this.props.user} relative={this.props.relative} relation={this.state.relation} sendRequest={this.sendRequest.bind(this)} />
